...
ColumnLayout {
    ...
    Binding on cfg_Image {
        ...
        when: root.configDialog.currentWallpaper === "org.wallpapercarousel.slideshow"
        ...
        Loader {
            ...
            function loadWallpaper () {
                let source = (root.configDialog.currentWallpaper == "org.kde.image") ? "ThumbnailsComponent.qml" :
                    ((root.configDialog.currentWallpaper == "org.wallpapercarousel.slideshow") ? "SlideshowComponent.qml" : "");

                let props = {screenSize: root.screenSize};

                if (root.configDialog.currentWallpaper == "org.wallpapercarousel.slideshow") {
